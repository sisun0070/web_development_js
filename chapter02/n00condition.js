...
// if (open) {
//     console.log("찾아주셔서 감사합니다. 금일은 휴무입니다. 😪");
// };

// 이상의 코드는 boolean 값을 변수에 대입하여 분기를 조절할 수 있습니다.
// 11번 라인은 open으로 실행되는데 반해, 15번 라인은 동일하게 open 변수입에도 실행되지 않는다는 점에서
// 분기를 조절 가능합니다.

// true를 반환하는 코드 혹은 false를 반환하는 코드
// let n =1;
// if(n > 0) {     
// // true를 반환하는 코드 혹은 false를 반환하는 코드 : 조건식
//     console.log("자연수입니다.")
// }
 ...
 * 그러므로 break;가 없다면 그 다음 case까지 실행이 된다는 점에서 유의할 필요가 있습니다.
 * 
 * n00Loops.js
 * index.html 생성
 */