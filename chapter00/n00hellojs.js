...
// 이상의 코드에서 자바스크립트 / 파이썬에서는 데이터의 종류를 구분하는 데
//있어 타 언어만큼 엄격한 기준이 있지 않습니다.
...
// // 이상의 코드에서 알 수 있는 점은 조건식에 자주 사용되구요, 비교 연산의
// // 결과값을 산출할 때 많이 사용 됩니다.
...
// console.log(typeof num2) // numver
...
// console.log(a > d, a >= d, a <= d);     // false false true
...
// // 문자열의 경우 알파벳 순서상 뒤에 오는 것을 더 크다고 판단
